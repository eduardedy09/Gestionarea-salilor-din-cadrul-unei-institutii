...
public class Evenimente {
   ...
   /* public String toString() {
        ...
        return String.valueOf(id_client) + "," + String.valueOf(id_sala) + "," + format1.format(data_inc) + "," + format1.format(data_fin) + "," + descriere + "," + format2.format(ora_inc) + "," + format2.format(ora_fin) + "\n";
    }*/
    ...
    public ArrayList<Evenimente> select (Connection con){
        ...
        try {
            ...
            /*for(Evenimente element:evenimente)
